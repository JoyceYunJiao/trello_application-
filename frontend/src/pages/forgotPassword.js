...
export default function ForgotPassword() {
  ...
  const handleSubmit = (event) => {
    ...
    fetch('http://localhost:9001/showUserByPassword/'+inputData.get("email"))
    .then(response => {
    ...
    .then(data => {
        ...
        if(data != null) {
            ...
            if(temp1){
                ...
                fetch('http://localhost:9001/updateUserPasswordByEmail?email='+inputData.get("email")+'&newPassword='+inputData.get("password"), {
                    method: 'POST',
                    headers: {
